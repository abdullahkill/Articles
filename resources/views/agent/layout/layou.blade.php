...
<head>
 ...
 <link rel="stylesheet" href="{{asset('vendors/prism/prism.css')}}" type="text/css">
    ...
    <!-- App styles -->
    <link rel="stylesheet" href="{{asset('assets/css/app.min.css')}}" type="text/css"><script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
...
{{View::make('agent/layout/header') }} 
{{View::make('agent/layout/side_bar') }} 
@yield('content')
@yield('modal')
@yield('jquery')
@yield('script')
