...
<div id="main">
    ...
    <div class="navigation">
        ...
        <div class="navigation-menu-tab">
            ...
            <div class="flex-grow-1">
                <ul>
                    <li>
                        <a href="/agentDashboard" data-toggle="tooltip" data-placement="right" title="Dashboards"
    ...
    <div class="navigation-menu-group">
        ...
        <div class="open" id="dashboards">
            <ul>
            <li>
                        <a href="/agentDashboard"> &nbspDashboard</a>
                            
                        </li>      
                         <li>
                        <a href="/project"><i class="fas fa-graduation-cap" ></i> &nbspProject</a>
                            
                        </li>
                        <li>
                        <a href="/post_project"><i class="fas fa-tasks"></i> &nbspTask</a>
