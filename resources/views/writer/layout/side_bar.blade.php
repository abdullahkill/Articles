...
<div id="main">
    ...
    <div class="navigation">
        ...
        <div class="navigation-menu-tab">
            ...
            <div class="flex-grow-1">
                <ul>
                    <li>
                        <a href="/writerDashboard" data-toggle="tooltip" data-placement="right" title="Dashboards"
    ...
    <div class="navigation-menu-group">
        ...
        <div class="open" id="dashboards">
            <ul>
            <li>
                        <a href="/writerDashboard"> &nbspDashboard</a>
                             </li>
                <li>
                        <a href="/viewnotification"><i class="fas fa-flag-checkered"></i> &nbspNotification</a>
                             </li>
                         </ul>
